...
public class GLCanvas
{
    ...
    public static void DrawRoundedBox(Rect box, float radius, Color color, float width, out Vector2 op1, out Vector2 op2, out Vector2 op3, out Vector2 op4, out Vector2 op5, out Vector2 op6, out Vector2 op7, out Vector2 op8)
    {
        Vector2 p1, p2, p3, p4, p5, p6, p7, p8;
        p1 = new Vector2(box.xMin + radius, box.yMin);
        p2 = new Vector2(box.xMax - radius, box.yMin);
